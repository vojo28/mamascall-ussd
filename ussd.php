...
try {
    ...
    // Log error to Sheets and email admin
    logError($session_id ?? 'N/A', $msisdn ?? 'N/A', count($input_history), $e->getMessage());

    // Generic user message
    echo "END An error occurred. Our team has been notified.";
}
?>
